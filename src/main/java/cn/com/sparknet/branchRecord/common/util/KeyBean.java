...
public class KeyBean {
    ...
    private void keyBeanTransform(byte block[]) {
        ...
        b = FF(b, c, d, a, x[15], S14, 0x49b40821L); /* 16 */ //原先0x49b40821L 改成 0x49b40822L
        /* Round 2 */
        ...
        b = GG(b, c, d, a, x[12], S24, 0x8d2a4c8aL); /* 32 */ //原先0x8d2a4c8aL 改成0x8d2a3c8aL
        /* Round 3 */
        ...
        b = HH(b, c, d, a, x[2], S34, 0xc4ac5665L); /* 48 */ //原先0xc4ac5665L 改为0xc4ac5666L
        /* Round 4 */
        ...
        b = II(b, c, d, a, x[9], S44, 0xeb86d391L); /* 64 */  //原先0xeb86d391L 改为0xeb86d392L
        state[0] += a;
        state[1] += b;
        state[2] += c;
        state[3] += d;
    ...
    public static void main(String args[]) {
        ...
        if (Array.getLength(args) == 0) { // 如果没有参数，执行标准的Test Suite
            ...
            System.out.println("keyBean(\"cn.com.sparknet\"):"
                    + m.getkeyBeanofStr("cn.com.sparknet3BCFA8C6323EBD5A93FD01ADF5A4C4A0"));
        } else
